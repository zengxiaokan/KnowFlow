...
from apps.chat.views import ask_question, regenerate
...
urlpatterns = [
    ...
    path("<int:knowledge_base_id>/update/", views.knowledge_base_update, name="knowledge_base_update"),
    path("<int:knowledge_base_id>/delete/", views.knowledge_base_delete, name="knowledge_base_delete"),
